...
namespace Lepton_Dictionary
{
    ...
    sealed partial class App : Application
    {
        ...
        public App()
        {
            ...
            Lepton_Library.LeptonLib.Initialize();
        }
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            AppViewModel.AsignValueToApplicationView();
            AppService.ExtensionManager.Initialize(CoreWindow.GetForCurrentThread().Dispatcher);
        }
